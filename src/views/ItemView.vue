  ...
  <div>
    <section id="itemView">
      <div class="container bookPath">
        ...
        <span class="ms-2 c-grey"> {{ book.title }}</span>
      </div>
      <div class="itemView-margined">
        <div class="content container">
          <div class="row">
            <div class="col-sm-md-12 col-6 pb-3">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-sm-md-12 col-6 p-relative p-3">
                    <div
                      class="d-flex flex-d-c align-items-center align-items-lg-start"
                    >
                      <p class="m-0 fw-bold">
                        {{ book.title }}
                      </p>
          ...
          <ul class="d-flex g-4 details-ul mt-3 p-0">
            <li class="details-li">Details</li>
          </ul>
    ...
    .purchase-box {
      ...
      .quantity-form {
        ...
        .quantity-input {
          ...
          &:focus {
            outline: none;
            border: 1px solid var(--lilac-hovered);
          }
        }
        i {
          cursor: pointer;
